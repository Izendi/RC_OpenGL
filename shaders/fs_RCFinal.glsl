...
void main()
{
    ...
    ivec2 texSize = textureSize(u_tex_2, 0);
    ...
    vec4 NW_0_color = texelFetch(u_tex_2, NW_R0_0, 0);
    vec4 NW_1_color = texelFetch(u_tex_2, NW_R1_0, 0);
    vec4 NW_2_color = texelFetch(u_tex_2, NW_R2_0, 0);
    vec4 NW_3_color = texelFetch(u_tex_2, NW_R3_0, 0);

    vec4 NE_0_color = texelFetch(u_tex_2, NE_R0_1, 0);
    vec4 NE_1_color = texelFetch(u_tex_2, NE_R1_1, 0);
    vec4 NE_2_color = texelFetch(u_tex_2, NE_R2_1, 0);
    vec4 NE_3_color = texelFetch(u_tex_2, NE_R3_1, 0);

    vec4 SE_0_color = texelFetch(u_tex_2, SE_R0_2, 0);
    vec4 SE_1_color = texelFetch(u_tex_2, SE_R1_2, 0);
    vec4 SE_2_color = texelFetch(u_tex_2, SE_R2_2, 0);
    vec4 SE_3_color = texelFetch(u_tex_2, SE_R3_2, 0);

    vec4 SW_0_color = texelFetch(u_tex_2, SW_R0_3, 0);
    vec4 SW_1_color = texelFetch(u_tex_2, SW_R1_3, 0);
    vec4 SW_2_color = texelFetch(u_tex_2, SW_R2_3, 0);
    vec4 SW_3_color = texelFetch(u_tex_2, SW_R3_3, 0);
