...
void main()
{
    ...
    float rayStartDistanceFromNode = 50.0; // test value is 50, shoudl be what is on the right //lvl_0_interval + lvl_1_interval + lvl_2_interval;
    float xyIntervalsPerWorkgroup = 16.0;
    float xyOffsetPerWorkgroup = xyIntervalsPerWorkgroup / 2.0;
