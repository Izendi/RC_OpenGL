...
glm::vec3 g_currentColor(0.0f, 1.0f, 0.0f);
glm::vec4 storedColor = glm::vec4(0.0f, 1.0f, 0.0f, 1.0f);
...
int main()
{
	...
	Shader sh_RCTexTest_RC1
	{
		"../../shaders/vs_RCTexTest_RC1.glsl",
	...
	*/
	...
	while (!glfwWindowShouldClose(up_window.get()))
	{
		...
		if (g_GuiData.activeShader == 4 || g_GuiData.activeShader == 5 || g_GuiData.activeShader == 6 || g_GuiData.activeShader == 7 || g_GuiData.activeShader == 8 || g_GuiData.activeShader == 9 || g_GuiData.activeShader == 10)
		{
			...
			g_GuiData.cmpShdRCLvl_0.setUniformArray("mouseX", 20, mouseXpos);
			g_GuiData.cmpShdRCLvl_0.setUniformArray("mouseY", 20, mouseYpos);
			...
			g_GuiData.csRC_4.setUniformArray("mouseX", 20, mouseXpos);
			g_GuiData.csRC_4.setUniformArray("mouseY", 20, mouseYpos);
			g_GuiData.csRC_4.setUniformInt("mouseIndex", mouseIndex);
			g_GuiData.csRC_4.setUniformVec3Array("u_circleColor", 20, circleColor);
			...
			g_GuiData.csRC_2.setUniformVec3Array("u_circleColor", 25, circleColor);
